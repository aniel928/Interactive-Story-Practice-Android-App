...
import com.example.anne.interactivestory.model.Page;
import com.example.anne.interactivestory.model.Story;
        ...
        if(page.isFinalPage()){
            ...
            choice2Button.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View view) {
                    //Closes this activity and goes back to the one that called it.
                    //finish();

                    //Instead, start back at page 0 with same name
                    loadPage(0);
                }
            });
        }else{
